...
import { MosheFindManyArgs } from "../../moshe/base/MosheFindManyArgs";
import { Moshe } from "../../moshe/base/Moshe";
...
export class UserControllerBase {
  ...
  async findManyMoshes(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<Moshe[]> {
    const query = plainToClass(MosheFindManyArgs, request.query);
    const results = await this.service.findMoshes(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  async connectMoshes(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: MosheWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      moshes: {
        connect: body,
  ...
  @common.Delete("/:id/moshes")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectMoshes(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: MosheWhereUniqueInput[]
  ): Promise<void> {
    const data = {
