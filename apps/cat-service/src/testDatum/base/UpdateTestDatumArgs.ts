...
@ArgsType()
class UpdateTestDatumArgs {
  @Field(() => TestDatumWhereUniqueInput, { nullable: false })
  where!: TestDatumWhereUniqueInput;
  @Field(() => TestDatumUpdateInput, { nullable: false })
  data!: TestDatumUpdateInput;
}

export { UpdateTestDatumArgs as UpdateTestDatumArgs };
