...
@ArgsType()
class UpdateTransactionMetaDatumArgs {
  @Field(() => TransactionMetaDatumWhereUniqueInput, { nullable: false })
  where!: TransactionMetaDatumWhereUniqueInput;
  @Field(() => TransactionMetaDatumUpdateInput, { nullable: false })
  data!: TransactionMetaDatumUpdateInput;
}

export { UpdateTransactionMetaDatumArgs as UpdateTransactionMetaDatumArgs };
